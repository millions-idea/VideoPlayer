...
import com.management.admin.biz.IRechargeService;
...
import com.management.admin.repository.RechargeMapper;
...
public class RechargeServiceImpl extends BaseServiceImpl<Recharge> implements IRechargeService {
    ...
    @Autowired
    public RechargeServiceImpl(RechargeMapper rechargeMapper, UserMapper userMapper, PayMapper payMapper) {
    ...
    public void add(String token, Double amount, Long systemRecordId) {
        ...
        recharge.setUserId(Long.valueOf(userId));
