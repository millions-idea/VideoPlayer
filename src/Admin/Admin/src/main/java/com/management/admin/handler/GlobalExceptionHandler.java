 ...
 * @desc
 */
package com.management.admin.handler;
...
/*    @ExceptionHandler(value = UsernameNotFoundException.class)
    ...
    public JsonResult preException(HttpServletRequest request,
        ...
        return new JsonResult().normalExceptionAsString(exception.getMessage() + ":" + exception.getCause());
    }
    ...
    public JsonResult preException(HttpServletRequest request,
        ...
        return new JsonResult().normalExceptionAsString("未知错误");
