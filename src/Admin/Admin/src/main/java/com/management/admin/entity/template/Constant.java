...
public interface Constant {
     ...
     * 系统默认头像
     */
    String UserPhoto = "https://stack-1251694474.cos.ap-guangzhou.myqcloud.com/zhixiao/default-avatar.png";

    /**
     * fastDFS文件服务器
     */
    String DFSUrl = "http://148.72.212.245:8010/group0/";
    String DFSIp = "148.72.212.245";
    String DFSUsername = "aiyello";
    String DFSPassword = "Pa123123!";
}
