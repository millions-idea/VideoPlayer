...
public class RemoteCommandUtil {
    ...
    private static String IP = Constant.DFSIp;
    private static String Username = Constant.DFSUsername;
    private static String Password= Constant.DFSPassword;
    ...
    public static String authExecute(String cmd){
