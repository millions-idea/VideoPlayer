...
public interface AccountMapper extends MyMapper<Accounts> {
    ...
    @Select("SELECT t1.*,t2.account FROM tb_accounts t1 LEFT JOIN tb_users t2 ON t1.trade_account_id = t2.user_id " +
     ...
     * @return
     */
    Map<String, BigDecimal> getSystemAccounts(@Param("id") Long id);
}
