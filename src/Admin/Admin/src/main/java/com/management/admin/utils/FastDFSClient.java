...
//	}
	...
	public static void main(String[] args) {
		/*File video = new File("C:\\video_convert\\temp.mp4");
		...
		try {
			...
			MultipartFile multipartFile = new MockMultipartFile(video.getName(), video.getName(),
					ContentType.APPLICATION_OCTET_STREAM.toString(), fileInputStream);
			FastDFSClient fastDFSClient = new FastDFSClient();
			String result = fastDFSClient.uploadFile(multipartFile);
