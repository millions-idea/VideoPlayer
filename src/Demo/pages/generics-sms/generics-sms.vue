<template>
	<view>
		...
		<template v-else>
				...
				<view class="sms-code-internal-container">
					<view class="sms-code-column">
						<template v-if="isActive1">
							<input :id="1" class="sms-code-char input-focus" maxlength="1" type="number" :value="codes[0]" @tap="showKeyboard" />
						</template>
						<template v-else>
							<input :id="1" :value="codes[0]" @tap="showKeyboard" class="sms-code-char" maxlength="1" type="number" />
						</template>
					</view>
					<view class="sms-code-column">
						<template v-if="isActive2">
							<input :id="2" :value="codes[1]" @tap="showKeyboard" class="sms-code-char input-focus" maxlength="1" type="number" />
						</template>
						<template v-else>
							<input :id="2" :value="codes[1]" @tap="showKeyboard" class="sms-code-char" maxlength="1" type="number" />
						</template>
					</view>
					<view class="sms-code-column">
						<template v-if="isActive3">
							<input :id="3" :value="codes[2]" @tap="showKeyboard" class="sms-code-char input-focus" maxlength="1" type="number" />
						</template>
						<template v-else>
							<input :id="3" :value="codes[2]" @tap="showKeyboard" class="sms-code-char" maxlength="1" type="number" />
						</template>
					</view>
					<view class="sms-code-column">
						<template v-if="isActive4">
							<input :id="4" :value="codes[3]" @tap="showKeyboard" class="sms-code-char input-focus" maxlength="1" type="number" />
						</template>
						<template v-else>
							<input :id="4" :value="codes[3]" @tap="showKeyboard" class="sms-code-char" maxlength="1" type="number" />
						</template>
					</view>
					<view class="sms-code-column">
						<template v-if="isActive5">
							<input :id="5" :value="codes[4]" @tap="showKeyboard" class="sms-code-char input-focus" maxlength="1" type="number" />
						</template>
						<template v-else>
							<input :id="5" :value="codes[4]" @tap="showKeyboard" class="sms-code-char" maxlength="1" type="number" />
						</template>
					</view>
					<view class="sms-code-column">
						<template v-if="isActive6">
							<input :id="6" :value="codes[5]" @tap="showKeyboard" class="sms-code-char input-focus" maxlength="1" type="number" />
						</template>
						<template v-else>
							<input :id="6" :value="codes[5]" @tap="showKeyboard" class="sms-code-char" maxlength="1" type="number" />
						</template>
					</view>
				</view>
			</view>
			...
			<view class="blank-line-50"></view>
			<button v-if="reGetButtonShow" class="reGetButton" hover-class="reGetButtonHover" :disabled="reGetButtonDisabled" @click="reGetSms">重新获取验证码</button>
		</template>
