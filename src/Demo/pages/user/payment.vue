<template>
	<view>
		<view class="notice">
			<uni-notice-bar v-if="!this.profile.exitsPayment" show-icon="true" single="true" text="为保障资金安全, 请您设置支付密码, 在本页设置后可直接消费 !"></uni-notice-bar>
		</view>
			...
			<view class="sms-code-internal-container">
				<view class="sms-code-column">
					<template v-if="isActive1">
						<input :id="1" class="sms-code-char input-focus" :disabled="true" :value="codes[0]" maxlength="1" @tap="showKeyboard" />
					</template>
					<template v-else>
						<input :id="1" class="sms-code-char" :disabled="true" :value="codes[0]" maxlength="1" @tap="showKeyboard" />
					</template>
				</view>
				<view class="sms-code-column">
					<template v-if="isActive2">
						<input class="sms-code-char input-focus" :disabled="true" :value="codes[1]" maxlength="1" @tap="showKeyboard" />
					</template>
					<template v-else>
						<input class="sms-code-char" :disabled="true" :value="codes[1]" maxlength="1" @tap="showKeyboard" />
					</template>
				</view>
				<view class="sms-code-column">
					<template v-if="isActive3">
						<input class="sms-code-char input-focus" :disabled="true" :value="codes[2]" maxlength="1" @tap="showKeyboard" />
					</template>
					<template v-else>
						<input class="sms-code-char" :disabled="true" :value="codes[2]" maxlength="1" @tap="showKeyboard" />
					</template>
				</view>
				<view class="sms-code-column">
					<template v-if="isActive4">
						<input class="sms-code-char input-focus" :disabled="true" :value="codes[3]" maxlength="1" @tap="showKeyboard" />
					</template>
					<template v-else>
						<input :id="1" class="sms-code-char" :disabled="true" :value="codes[3]" maxlength="1" @tap="showKeyboard" />
					</template>
				</view>
				<view class="sms-code-column">
					<template v-if="isActive5">
						<input class="sms-code-char input-focus" :disabled="true" :value="codes[4]" maxlength="1" @tap="showKeyboard" />
					</template>
					<template v-else>
						<input class="sms-code-char" :disabled="true" :value="codes[4]" maxlength="1" @tap="showKeyboard" />
					</template>
				</view>
				<view class="sms-code-column">
					<template v-if="isActive6">
						<input class="sms-code-char input-focus" :disabled="true" :value="codes[5]" maxlength="1" @tap="showKeyboard" />
					</template>
					<template v-else>
						<input class="sms-code-char" :disabled="true" :value="codes[5]" maxlength="1" @tap="showKeyboard" />
					</template>
				</view>
			</view>
		</view>
