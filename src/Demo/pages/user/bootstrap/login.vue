<template>
	<view>
		<view class="container">
			<view class="item"><input class="item-input" maxlength="11" type="text" placeholder="请输入账号" value="" @input="changePhone" /></view>

			<view class="item"><input class="item-input" maxlength="128" type="text" placeholder="请输入密码" value="" :password="true" @input="changePassword" /></view>
