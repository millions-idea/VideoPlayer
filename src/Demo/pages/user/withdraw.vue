<template>
	<view>
		...
		<view class="recharge">
			<view class="recharge-item small-item"><text class="recharge-label gray">可提现余额</text></view>
		...
		<view class="recharge">
			<view class="recharge-item small-item"><text class="recharge-label gray">提现金额</text></view>
			<view class="recharge-item">
				<view class=""><input class="amount" maxlength="9" type="number" value="" @input="changeInput" /></view>
			</view>
		</view>
		...
		<view class="recharge">
			<view class="recharge-item small-item"><text class="recharge-label gray">支付宝账号</text></view>
			<view class="recharge-item">
				<view class=""><input class="name" maxlength="20" type="text" value="" @input="changeFinanceId" /></view>
			</view>
		</view>
		...
		<view class="recharge">
			<view class="recharge-item small-item"><text class="recharge-label gray">真实姓名</text></view>
			<view class="recharge-item">
				<view class=""><input class="name" maxlength="10" type="text" value="" @input="changeRealName" /></view>
			</view>
		</view>
