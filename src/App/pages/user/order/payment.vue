				...
				<view class="grace-list ">
					<navigator v-if="amount > 0" class="items" url="" @tap="useAlipay">
						<view class="icons">
							<image
								class="icon"
								src="../../../static/user/payment-alipay.png"
							></image>
						</view>
					...
					<navigator class="items" url="" @tap="useBalance">
						<view class="icons">
							<image
								class="icon"
								src="../../../static/user/payment-master.png"
							></image>
						</view>
						<view class="title">
							余额支付
							...
							_self.$api
								...
								.then(__res => {
									...
									if (_self.common.Response.isFaild(__res.data)) {
										if (
											__res.data.msg.length < 10 &&
											__res.data.msg.indexOf('null') == -1 &&
											__res.data.msg.indexOf('fail') == -1
										) {
											uni.showToast({
												icon: 'none',
