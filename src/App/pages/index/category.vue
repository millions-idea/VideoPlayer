	...
	<view>
		...
		<view class="flex-container">
			<view class="least-container">
				<view class="left_1">
					<view class="left_1_box">
						<image
							@tap="onClick(left_1_box)"
							:src="left_1_box.image"
							class="box_img"
						></image>
					</view>
				</view>
				<view class="right_1">
					...
					<view class="bottom_1">
						<view class="left_box_2">
							<image
								@tap="onClick(left_box_2)"
								:src="left_box_2.image"
								class="box_img"
							></image>
						</view>
						<view class="right_box_2">
							<image
								@tap="onClick(right_box_2)"
								:src="right_box_2.image"
								class="box_img"
							></image>
						</view>
					</view>
			...
			<view class="largest-container">
				<view class="largest-box">
					<image
						@tap="onClick(largest_box)"
						:src="largest_box.image"
						class="box_img"
					></image>
				</view>
			</view>
			<view class="balance-container">
				<view class="balance-box">
					<view class="left_box_3">
						<image
							@tap="onClick(left_box_3)"
							:src="left_box_3.image"
							class="box_img"
						></image>
					</view>
					<view class="right_box_3">
						<image
							@tap="onClick(right_box_3)"
							:src="right_box_3.image"
							class="box_img"
						></image>
					</view>
				</view>
...
export default {
	...
	methods: {
		onClick(e){
			this.common.window.toNew("category/detail", {
